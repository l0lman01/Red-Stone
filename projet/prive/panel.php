    ...
    <body>
        ...
        <div class="row adminTab">
            ...
            <div id="user" class="col s12">
                ...
                <?php }else{ ?>
                    <h2>Vous n'avez pas accès à cette page</h2> <!-- Si user n'est pas un admin -->
                <?php }

            }else{ ?>
            <h2>Connectez-vous pour accéder a cette page</h2> <!-- Si user n'est pas connecté en tant que admin -->
            <?php }
